...
export const shipWays = [
  {
    way: '掌櫃（推薦）',
    key: 'palmbox',
    hint: `掌櫃提供櫃到櫃的寄件取件服務，便利快捷。大、中、小櫃機<span class="g-origin-price">原價60/55/50</span>，贈物網上通通均一價45元。<br />
  請確保您寄送的物品體積小於最大格櫃門的尺寸31x34x41cm。<br />
  在贈物網上預設是使用小格的櫃門，您可以在操作櫃機時修改成符合您需求的尺寸格子。<br /><br />`,
    radios: [
      {
        id: 'palmbox-0',
        text: '索取者(貨到付款)',
  ...
  },
  {
    ...
    key: 'fami',
    hint:
      '使用「全家」店到店寄送物資，全家將回饋1元給贈物網，以利此社會企業永續經營。',
    radios: [
      {
        id: 'fami-0',
        text: '索取者(匯款給贈送者)',
  ...
  },
  {
    ...
    key: 'hct',
    hint:
      '新竹物流單箱物品總長度180cm內，重量25KG以下，全台灣本島均一價150元。',
    radios: [
      {
        id: 'hct-0',
        text: '索取者(貨到付款)',
