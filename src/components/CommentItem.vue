<template>
  <div class="comment-item">
    <div class="detail">
      ...
      <div class="detail-right" v-if="isMySelf && cType === 'request'">
...
export default {
  ...
  methods: {
    ...
    toChatroom () {
      ...
      this.getChatId({ type, thingId: this.info.gift_request_id, directUserId: this.info.from_user_id, cb: this.getChatIdCb })
