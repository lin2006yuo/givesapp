    ...
    <div class="content g-smooth">
      <div class="newgift-step-first">
        ...
        <group class="newgift-content-panel">
          ...
          <x-number
            title="當前數量"
            :max="newGift.quantity"
            :min="newGift.quantity"
            width="30px"
            button-style="round"
          ...
          <x-number
            title="新增數量"
            :max="50 - newGift.quantity"
            :min="0"
            width="30px"
            button-style="round"
            v-model="newGift.increase"
          />
          <x-textarea
            :max="500"
            :row="5"
  ...
  methods: {
    ...
    getGiftInfoCb () {
      const {gift_images: giftImages, quantity,
        title, desc, show_at: showAt} = this.currentGift
    ...
    modify () {
      ...
      if (!this.isModify) {
        ...
        const {desc, increase} = this.newGift
        let data = {
