  ...
  <div class="request g-smooth">
    ...
    <div class="content">
      <group class="section-flex">
        ...
        <x-number v-model="request.reqQuantity" button-style="round" :min="1" :max="giftInfo.left">
        </x-number>
      </group>
      <group>
    ...
    <group class="section-info">
      ...
      <div class="extort-btn">
        <x-button @click.native="toRequest" class="btn" :disabled="isAbledToReq"  type="primary">確認索取</x-button>
      </div>
    </div>
  </div>
</template>
...
<script>
import { Group, XNumber, XTextarea, Radio, XButton, PopupPicker } from 'vux'
